...
export const CHECK_HASH = "CHECK_HASH";
...
export const authReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case LOAD_NEW_AVATAR:
      return {
        ...state,
        owner: { ...state.owner, avatar: action.payload.data },
      };
    ...
    case UNSUBSCRIBE_CHANGE_OWNER:
      return {
        ...
        owner: {
          ...state.owner,
          subscriptions: state.owner.subscribers.filter(
            (item) => item === action.payload.subscribeUserId
          ),
        },
      };
...
//actions
export const loadNewAvatarAction = (payload) => ({
  type: LOAD_NEW_AVATAR,
  payload,
});
export const logoutAction = (payload) => ({ type: LOGOUT });
export const unsubscribeChangeOwnerAction = (payload) => ({
  type: UNSUBSCRIBE_CHANGE_OWNER,
  payload,
});
export const updateOwnerInformationAction = (payload) => ({
  type: UPDATE_OWNER_INFORMATION,
  payload,
});
export const checkHashAction = (payload) => ({ type: CHECK_HASH, payload });
